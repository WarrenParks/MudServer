...
{
    private readonly Mock<ILogger<ChatManager>> loggerMock;
    ...
    {
        // Setup mocks
        loggerMock = new Mock<ILogger<ChatManager>>();
        ...
        chatManager = new ChatManager(connectionManagerMock.Object, loggerMock.Object);
    }
    ...
    public async Task SendMessageAsync_WithSpecificRecipient_ShouldSendMessageToSpecificClient()
    {
        ...
        // Act
        await chatManager.SendMessageAsync(message, senderClientId, recipientClientId, CancellationToken.None);
    ...
    public async Task SendMessageAsync_WithoutRecipient_ShouldSendToAllConnections()
    {
        ...
        // Act
        await chatManager.SendMessageAsync(message, senderClientId, CancellationToken.None);
    ...
    public async Task SendMessageAsync_WhenConnectionManagerReturnsNull_ShouldNotThrowException()
    {
        ...
        var exception = await Record.ExceptionAsync(() =>
            chatManager.SendMessageAsync("Test", senderClientId, recipientClientId, CancellationToken.None));
