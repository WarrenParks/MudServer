...
public class ClientTests
{
  ...
  private readonly Mock<IChatManager> _chatManagerMock;
  ...
  public ClientTests()
  {
    ...
    _chatManagerMock = new Mock<IChatManager>();
  ...
  public async Task StartAsync_AddsAndRemovesConnection()
  {
    ...
    _webSocketMock.Verify(w => w.CloseAsync(WebSocketCloseStatus.NormalClosure, "Closing", It.IsAny<CancellationToken>()), Times.Once);
  }
